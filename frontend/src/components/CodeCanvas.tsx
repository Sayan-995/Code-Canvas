...
const CodeCanvasContent: React.FC<CodeCanvasProps> = ({ files, onBack, onFileUpdate, onFlowStateChange }) => {
  ...
  return (
    ...
    >
      ...
      `}</style>
      <div className="absolute top-2 sm:top-4 left-2 sm:left-4 z-10 flex flex-wrap gap-1.5 sm:gap-2">
        <button 
          onClick={onBack}
          className="bg-gray-800 text-white px-2 sm:px-4 py-1.5 sm:py-2 rounded-lg border border-gray-700 hover:bg-gray-700 transition-colors text-xs sm:text-sm"
        >
        ...
        <button
          ...
          className={`px-2 sm:px-4 py-1.5 sm:py-2 rounded-lg border transition-colors flex items-center gap-1 sm:gap-2 text-xs sm:text-sm ${
            isDrawing 
